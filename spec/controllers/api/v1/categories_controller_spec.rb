...
RSpec.describe Api::V1::CategoriesController, type: :request do
  ...
  describe 'mutation tests' do
    context 'when trying to load a non-existing category' do
      it 'returns an error' do
        post api_v1_category_path('not_found'), params: { id: 'not_found' }
    ...
    context 'when passing an argument other than an id' do
      it 'returns an error' do
        post api_v1_category_path(self), params: { id: 'not_found' }
