...
class GraduationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create graduation" do
    assert_difference('Graduation.count') do
      post graduations_url, params: { graduation: { description: @graduation.description, person_id: @graduation.person_id, title: @graduation.title } }
    end
  ...
  test "should update graduation" do
    patch graduation_url(@graduation), params: { graduation: { description: @graduation.description, person_id: @graduation.person_id, title: @graduation.title } }
