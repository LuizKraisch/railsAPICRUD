...
class OpportunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post opportunities_url, params: { opportunity: { description: @opportunity.description, initial_date: @opportunity.initial_date, salary: @opportunity.salary, title: @opportunity.title } }
    end
  ...
  test "should update opportunity" do
    patch opportunity_url(@opportunity), params: { opportunity: { description: @opportunity.description, initial_date: @opportunity.initial_date, salary: @opportunity.salary, title: @opportunity.title } }
