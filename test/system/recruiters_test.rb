...
class RecruitersTest < ApplicationSystemTestCase
  ...
  test "creating a Recruiter" do
    ...
    fill_in "Area", with: @recruiter.area
    fill_in "Description", with: @recruiter.description
    fill_in "Organization", with: @recruiter.organization_id
    fill_in "Person", with: @recruiter.person_id
